...
form.addEventListener("submit", (e) => {
    ...
    if(genre === `Action`||genre === `Adventure` ||genre === `Animation` ||genre === `Comedy` ||genre === `Crime` ||genre === `Drama` ||  genre ===`Horror` ||genre === `Romance` || genre === `Space` ||genre === `Sci-fi` ||genre === `hriller` ||genre === `War`){
